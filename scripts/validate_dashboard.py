#!/usr/bin/env python3
"""Validate the balanced-layout, expanded-layer-reference dashboard release.

The checks cover prepared-data integrity, hotspot classification, locator geometry,
self-contained HTML content, the revised information architecture, and package-level
consistency. Browser interactions and responsive layout are exercised separately by
the documented Playwright smoke-test workflow.
"""
...
def main() -> None:
    ...
    required_html_strings = [
        ...
        "Measurement",
        "How to interpret",
        "Potential planning use",
        "Important limitation",
        "Understand the current layer and selected place",
        "Dashboard architecture and reproducibility",
        "Purpose and intended use",
        "main_section_nav",
        "gmt_30_model_pr_ssp_mean",
        "gmt_30_pr_Kriging",
        "harris_census_tract_extreme_precipi_gmt_30",
        "harris_future_land_use_2050",
        "harris_housing_unit_change_2020_2050",
        "harris_census_tract_CHEI_2050",
        "harris_census_tract_social_vulnerability_index_2020",
        "Kaifa.Lu@ttu.edu",
    ]
    ...
    result = {
        ...
        "balanced_layout_release": True,
    }
    print("Balanced-layout dashboard validation passed.")
