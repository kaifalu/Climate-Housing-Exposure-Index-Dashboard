...
""")
    ...
    add_key_value_table(doc, [
        ...
        ("kriging_gmt_*", "Numeric grids, Bokeh RGBA grids, PNG review maps, and fitted model metadata"),
        ("data_quality_report.json", "Counts, totals, exposed-layer audit, duplication check, and privacy note"),
    ])

    # Page 7.
    new_page(doc, "06  DASHBOARD USE", "Layer exploration and overlap screening", "Controls are intentionally transparent and interpretable")
    ...
    add_body(doc, "CHEI, kriging, regional growth forecasts, parcel projections, and vulnerability indicators are screening inputs. The dashboard is designed to reveal spatial co-location and support further analysis; it does not establish causality, engineering design criteria, parcel-level eligibility, or an official risk determination.")
